class Spaceship:
    def __init__(self, name, position, velocity, acceleration):
        self.name = name
        self.position = position #Координаты в пространстве (Position_X, Position_Y)
    ...
    def update_velocity(self, time_delta):
        #Обновляем скорость корабля на основе ускорения и прошедшего времени
    ...
    def update_position(self, time_delta):
        #Обновляем позицию корабля на основе скорости, ускорения и прошедшего времени
